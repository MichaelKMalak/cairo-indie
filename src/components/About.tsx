  ...
  return (
    <section id="about" className="py-16 container">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        <div>
          <h2 className="text-3xl font-gunterz font-bold mb-6 text-[#390c86]">About Us</h2>
        ...
        <div>
          <h2 className="text-3xl font-gunterz font-bold mb-6 text-[#f52e38]">Why & Who We Are</h2>
