  ...
  return <footer className="bg-[#390c86] text-white py-10 mt-auto font-montserrat">
      <div className="container">
        <div className="flex flex-col md:flex-row items-center justify-between mb-8">
          <div className="flex items-center gap-2 mb-4 md:mb-0">
            <img 
              ...
              className="h-6 w-6"
            />
            <span className="text-xl font-archivoblack font-bold tracking-tight">CIFC</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-lg font-medium mb-3 text-[#cef2e7] font-archivoblack">About</h3>
            <p className="text-white/80 text-sm">
              A community for indie filmmakers in Cairo committed to creating films consistently.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-medium mb-3 text-[#cef2e7] font-archivoblack">Contact</h3>
          ...
          <div>
            <h3 className="text-lg font-medium mb-3 text-[#cef2e7] font-archivoblack">Join Us</h3>
            <p className="text-white/80 text-sm">
