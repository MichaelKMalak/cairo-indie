  ...
  return (
    <section id="features" className="py-16 container bg-gradient-to-b from-white to-[#cef2e7]/30">
      <div className="text-center mb-12">
        <h2 className="text-3xl font-bebasneue font-bold mb-4 text-[#390c86]">Why Join Our Club</h2>
        ...
        {features.map((feature, index) => (
          <Card key={index} className="border border-[#cef2e7] transition-all hover:shadow-md bg-white">
            <CardHeader className="pb-2">
              ...
              <CardTitle className="text-[#390c86] font-bebasneue">{feature.title}</CardTitle>
            </CardHeader>
            <CardContent>
